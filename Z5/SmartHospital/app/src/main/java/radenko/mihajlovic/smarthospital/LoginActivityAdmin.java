...
public class LoginActivityAdmin extends AppCompatActivity implements View.OnClickListener, ServiceConnection {
     ...
     private IBinderAIDL mService = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonBind = findViewById(R.id.bind);
        buttonUnbind = findViewById(R.id.unbind);
...
//ovde se uredjaji citaju iz baze i prikazuju u login aktivitiju za admina
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.dodaj_uredjaj){
            ...
            //automatski kreiramo servis sve dok postoji binding
    ...
    public void onServiceConnected(ComponentName name, IBinder service) {
        mService = IBinderAIDL.Stub.asInterface(service);
    ...
    public void onServiceDisconnected(ComponentName name) {
        Log.d("MainActivity", "onServiceDisconnected-error");
        mService = null;
    }
