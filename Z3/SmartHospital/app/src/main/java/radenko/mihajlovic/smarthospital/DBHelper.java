...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + TABLE_NAME_U + "(" + COLUMN_NAZIV + " TEXT, " + COLUMN_SLIKA + " INTEGER, " + COLUMN_PREKIDAC + " INTEGER);");
    ...
    public void insertInUredjaji(admin_view uredjaj){
        ...
        values.put(COLUMN_PREKIDAC, uredjaj.isPrekidac());
    ...
    public Korisnik readKorisnik(String id){
    ...
    private admin_view createUredjaj(Cursor cursor){
        ...
        return new admin_view(naziv, slika, stanje_prekidaca);
    }
